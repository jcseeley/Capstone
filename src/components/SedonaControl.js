      ...
      <div className="grid grid-cols-2 mt-2">
        <div className='justify-self-center text-center w-3/4 max-w-xl ml-2 mt-4 mr-2 mb-4 px-2'>
          ...
          <div className="flex justify-center">
            <button className="block text-sm text-orange-900 border-2 border-solid border-orange-900 bg-orange-300 hover:bg-gradient-to-t from-orange-300 to-orange-200 font-bold py-2 px-4 rounded ml-2 mr-2 mb-4" onClick={() => props.onPropertySelection("House")}>House Info</button>
          </div>
          </div>
        </div>
        ...
        <Carousel className="border-2 border-solid border-orange-900" animationHandler="fade" autoPlay={true} infiniteLoop={true} swipeable={false} showThumbs={false}>
          ...
          <div className="flex justify-center">  
            <button className="block text-sm text-orange-900 border-2 border-solid border-orange-900 bg-red-300 hover:bg-gradient-to-t from-red-300 to-red-200 font-bold py-2 px-4 rounded ml-2 mr-2 mb-4" onClick={() => props.onPropertySelection("Studio")}>Studio Info</button>
          </div>
          </div>
        </div>
      </div>
